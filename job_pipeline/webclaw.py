...
WebClaw may be used on any website: there is intentionally no pipeline-side
host allowlist here. Host policy lives in config/access_policy.json
(``webclaw.allowed_hosts``, default "any"); see
:func:`job_pipeline.access_policy.webclaw_host_allowed` if a future caller
needs to enforce an explicit host list.
"""
